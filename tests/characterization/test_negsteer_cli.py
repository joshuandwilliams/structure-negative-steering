...
EXPECTED_STAGES = [
    ...
    ("negsteer_coldstart.py", "kickoff-distances"),
    ("negsteer_coldstart.py", "kickoff-prefilter"),
    ("reversion.py", "build-contaminated"),
    ("reversion.py", "plan-reversions"),
    ("reversion.py", "harvest-reversions"),
    ("negsteer_coldstart.py", "kickoff-finalize"),
    ("negsteer_aggregate.py", "aggregate"),
    ("negsteer_aggregate.py", "compute-final-metrics"),
    ("negsteer_aggregate.py", "aggregate-per-sequence"),
